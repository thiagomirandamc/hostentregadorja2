...
$cult = "SELECT * FROM usuario WHERE nome ='$usuario'";
             ...
             $permissao = $rspl['permissao']; } }    ?>                
                    ...
                    <div class="content">
                        <a href="entregasporestabelecimento.php" type="button" class="button is-block is-link is-rounded is-large is-fullwidth">Entregas por Estabelecimento</a>
                    </div>
                    <?php }  
                   ...
                   if ($permissao == '1' || $permissao == '4') { ?>
                    <div class="content">
                        <a href="entregasdoestabelecimento.php" type="button" class="button is-block is-link is-rounded is-large is-fullwidth">Entregas do estabelecimento</a>
                    </div>  
                   <?php } ?> 
                   <div class="content">
